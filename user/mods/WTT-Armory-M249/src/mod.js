...
class WTTArmoryM249 {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] WTT-Armory-M249`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] A Collaboration between Choccster and the WTT Team`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] Kept you waiting, huh?`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
